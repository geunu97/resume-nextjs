...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '폴라리스오피스(2024.06 ~ 현재)에서는 WebAssembly 기반의 웹오피스(WebOffice) JavaScript SDK를 개발해 문서 편집 기능의 구조를 개선하고 고도화했으며, 해당 SDK는 60여 개 파트너사에 납품되어 매출 483% 성장을 기록했습니다. 파트너사 문의 대응·라이선스 발급 같은 단순 반복 업무는 AI에게 절차를 알려주는 작업 지침(Claude Code 스킬) 15개로 자동화했습니다.',
