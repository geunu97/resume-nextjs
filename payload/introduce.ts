...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '폴라리스오피스(2024.06 ~ 현재)에서는 WebAssembly 기반의 WebOffice JavaScript SDK 개발을 담당하며 문서 편집 기능의 구조 개선과 기능 고도화를 수행했고, 해당 SDK는 60여 개 파트너사에 납품되어 매출 475% 성장을 기록했습니다. 또한 LGU+/KT PASS Office 프로젝트에서 B2C용 WebView 환경을 구축하고 Native-Web 브릿지를 구현했으며, 해당 서비스는 출시 8개월 만에 유료 구독자 3만 명을 확보했습니다.',
